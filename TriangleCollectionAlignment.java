...
@Autonomous(name="Auto: Triangular Detector Alignment")
public class TriangleCollectionAlignment extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TriangleDetector.ConeLocation location = detector.getLocation();
        ...
        while (opModeIsActive()) {
            if (detector.getLocation() != TriangleDetector.ConeLocation.NONE) {
